...
<%@page import="com.controller.dto.TransactionDto"%>
		...
		<div class="navbar-container ace-save-state" id="navbar-container">
			...
			<div class="navbar-buttons navbar-header pull-right"
				...
				<li class="light-blue dropdown-modal"><a data-toggle="dropdown"
					href="#" class="dropdown-toggle"> <!-- 								<img class="nav-user-photo" src="assets/images/avatars/user.jpg" alt="Jason's Photo" /> -->
	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<div id="sidebar"
			...
			<ul class="nav nav-list">
				<li class=""><a href="deposit.jsp"> <i
						class="menu-icon fa fa-rupee"></i> <span class="menu-text">
							Deposit </span>
				</a> <b class="arrow"></b></li>
				<li class=""><a href="withdraw.jsp"> <i
						class="menu-icon fa fa-rupee"></i> <span class="menu-text">
							Withdraw </span>
				</a> <b class="arrow"></b></li>
				<li class=""><a href="transaction.jsp"> <i
						class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
							Get Summary </span>
				</a> <b class="arrow"></b></li>
				
				<li class=""><a href="transaction?toa=savings"> <i
						class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
							Savings </span>
				</a> <b class="arrow"></b></li>
				
				<li class=""><a href="transaction?toa=current"> <i
						class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
							Current </span>
				</a> <b class="arrow"></b></li>
				<li class="">
				...
				<div class="page-content">
					...
					<div class="page-header">
						...
						overflow: scroll;
						 ...
						 border-collapse:
						collapse; width: 100%; }
						 td, th { background-color: lightblue;
						border: 1px solid #dddddd; 
						text-align: left;
						 padding: 8px; }

						tr:nth-child(even) { background-color: #dddddd; } tbody { height:
						...
						<body>
						<br>
						<h3><b>Your Account Number is : <%=request.getAttribute("accNo") %><b></b></h3></b>
						<br>
							<div id="overflowTest">
								<table>
									<tbody>
...
<%
List<TransactionDto> transactions=(List<TransactionDto>)request.getAttribute("transactionlist");
	...
	<div class="footer">
		<div class="footer-inner">
			<div class="footer-content">
				<span class="bigger-120"> <span class="blue bolder">Bank</span>
